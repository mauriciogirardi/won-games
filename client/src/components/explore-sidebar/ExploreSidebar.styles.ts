...
import { Label as LabelRadio } from '../radio/Radio.styles'
import { Label as LabelCheckbox } from '../checkbox/Checkbox.styles'
...
export const ExploreSidebarContainer = styled.aside.withConfig(
